...
: ${CATALINA_CONNECTOR_KEYSTORE:=/etc/ssl/tomcat/tomcat.jks}
: ${CATALINA_CONNECTOR_KEYSTORE_PASSWORD:=}
: ${CATALINA_CONNECTOR_KEYSTORE_TYPE:=JKS}
: ${CATALINA_CONNECTOR_TRUSTSTORE_TYPE:=JKS}
...
CATALINA_OPTS="${CATALINA_OPTS} -DcatalinaConnectorKeystoreType=${CATALINA_CONNECTOR_KEYSTORE_TYPE}"
CATALINA_OPTS="${CATALINA_OPTS} -DcatalinaConnectorTruststoreType=${CATALINA_CONNECTOR_TRUSTSTORE_TYPE}"
